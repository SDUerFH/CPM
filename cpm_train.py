...
parser.add_argument('--lsp-root', metavar='DIR',
                    default='E:/学习资料/研一/姿态识别/WeightedLoss_Convolutional_Pose_Machines/data/LSP',
...
parser.add_argument('--ckpt-dir', metavar='DIR', default='./model',
                    help='path to save checkpoints')
parser.add_argument('--summary-dir', metavar='DIR', default='./summary',
...
def train():
    ...
    for epoch in range(int(args.start_epoch), args.epochs):
        ...
        for batch_idx, sample in enumerate(train_loader):
            # image是图片的原始数据,一动未动, gt_map是(15, 45, 45)的数据,
            ...
            optimizer.zero_grad()
            # 注意这里是对原始图像进行操作,经过模型后得到的预测结果与 gt_map 求 loss
